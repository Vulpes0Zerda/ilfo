...
import { AnimationContext, LanguageContext, PointContext, LevelContext, TooltipContext, PopUpContext, } from './GlobalContext';
...
import { handleCurrentPoints, handleMaxPoints, handleLevel, handleLanguage, handleAnimation, handleTooltip, handleWarning, handleError, } from './logic/reducer/handlers';
import { maxPointsBlueprint, currentPointsBlueprint, languageBlueprint, levelBlueprint, animationBlueprint, warningBlueprint, errorBlueprint, } from './logic/reducer/blueprints';
const App = () => {
    const [menuAnimation, dispatchMenuAnimation] = useReducer(handleAnimation, animationBlueprint);
    const [settingsAnimation, dispatchSettingsAnimation] = useReducer(handleAnimation, animationBlueprint);
    ...
    const [currentPoints, dispatchCurrentPoints] = useReducer(handleCurrentPoints, currentPointsBlueprint());
    ...
    return (<div className="App">
            ...
            pointsLookup,
                    ...
                    <PopUpContext.Provider value={{ warning, dispatchWarning, error, dispatchError }}>
                        <LanguageContext.Provider value={{ language, languagesLookup, dispatchLanguage, translation }}>
