...
const Options = ({minLvl, maxLvl, currentLvl}) => {
    return (
        <div id="options">
            <label className="left-colum">Language</label>
            <select id="lang" className="right-colum" name="lang">
                <option value="EN" id="lang-en">En</option>
                <option value="DE" id="lang-de">De</option>
            </select>
            <label className="left-colum">Character Level</label>
            <input type="number" name="level" id="settingsLevel" className="right-colum" min={minLvl} max={maxLvl} value={currentLvl}/>
            <span className="left-colum">Skill Tooltips</span>
            <input type="checkbox" id="settingsTooltips" className="noCheck" checked="checked" name="tooltips" />
            <label id="settingsTooltipsLbl" className="right-colum" for="settingsTooltips">
                <svg
